...
void group_gain (CHAR_DATA * ch, CHAR_DATA * victim)
{
    char buf[MAX_STRING_LENGTH];
    CHAR_DATA *gch;
    // CHAR_DATA *lch; // This variable is declared but never used, pending deletion
    int xp;
    int members;
    int group_levels;
    ...
    // lch = (ch->leader != NULL) ? ch->leader : ch; // This variable is declared but never used, pending deletion

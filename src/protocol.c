...
static variable_name_t VariableNameTable[eMSDP_MAX+1] = 
{
   ...
   { eMSDP_AC_PIERCE,        "AC_PIERCE",        NUMBER_READ_ONLY }, 
   { eMSDP_AC_BASH,          "AC_BASH",          NUMBER_READ_ONLY }, 
   { eMSDP_AC_SLASH,         "AC_SLASH",         NUMBER_READ_ONLY }, 
   { eMSDP_AC_EXOTIC,        "AC_EXOTIC",        NUMBER_READ_ONLY }, 
